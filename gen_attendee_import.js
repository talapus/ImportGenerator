...
var getInput = function() {
  if (!process.argv[2]) {
    input = 1
  } else if (process.argv[2] = NaN) {
    input = 1  // this is worthless but non-obstructing code. Make it work
  }
}

var printAttendees = function() {
  for (i=0; i < input; i++) {
    console.log(i+1 + ", " + fake.company.bs());
  }
}
